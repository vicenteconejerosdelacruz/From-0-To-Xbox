...
void App::SetWindow(CoreWindow^ window)
{
	...
	scene->Initialize(renderer->frameCount, renderer->d3dDevice, renderer->commandList, directionalLight->shadowMap, spotLight->shadowMap, pointLight->shadowMap, "Assets/messy_tavern/scene.gltf");
