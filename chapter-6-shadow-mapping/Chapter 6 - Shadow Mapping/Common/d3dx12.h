...
//
//  Archivo:       d3dx12.h
//  Contenido:    Biblioteca de utilidades D3DX12
//
//////////////////////////////////////////////////////////////////////////////
...
struct CD3DX12_CLEAR_VALUE : public D3D12_CLEAR_VALUE
{
    ...
    {
        Format = format;
        /* Use memcpy para conservar los valores NAN */
...
//------------------------------------------------------------------------------------------------
// Devuelve el tamaño necesario de un búfer que se va a utilizar para cargar datos
...
//------------------------------------------------------------------------------------------------
// Se deben rellenar todas las matrices (por ejemplo, llamando a GetCopyableFootprints)
...
//------------------------------------------------------------------------------------------------
// Implementación UpdateSubresources de asignación del montón
inline UINT64 UpdateSubresources( 
    _In_ ID3D12GraphicsCommandList* pCmdList,
    _In_ ID3D12Resource* pDestinationResource,
    _In_ ID3D12Resource* pIntermediate,
...
//------------------------------------------------------------------------------------------------
// Implementación UpdateSubresources de asignación de pila
...
{
    // Esta conversión es útil para pasar punteros de lista de comandos con establecimiento inflexible de tipos a
    // ExecuteCommandLists.
    // Esta conversión es válida mientras se respete la declaración como const. Las API D3D12
    // respetan la declaración como const de sus argumentos.
