...
struct Pyramid {
  ...
  static constexpr VertexType vertices[] = {
    { XMFLOAT3( 1.0f, 0.0f,  1.0f), XMFLOAT3(0.0f,  0.4472136f,  0.8944272f), XMFLOAT2(1.0f, 1.0f) },
    { XMFLOAT3( 0.0f, 2.0f,  0.0f), XMFLOAT3(0.0f,  0.4472136f,  0.8944272f), XMFLOAT2(0.5f, 0.0f) },
    { XMFLOAT3(-1.0f, 0.0f,  1.0f), XMFLOAT3(0.0f,  0.4472136f,  0.8944272f), XMFLOAT2(0.0f, 1.0f) },

    { XMFLOAT3(-1.0f, 0.0f, -1.0f), XMFLOAT3(0.0f,  0.4472136f, -0.8944272f), XMFLOAT2(1.0f, 1.0f) },
    { XMFLOAT3( 0.0f, 2.0f,  0.0f), XMFLOAT3(0.0f,  0.4472136f, -0.8944272f), XMFLOAT2(0.5f, 0.0f) },
    { XMFLOAT3( 1.0f, 0.0f, -1.0f), XMFLOAT3(0.0f,  0.4472136f, -0.8944272f), XMFLOAT2(0.0f, 1.0f) },
    
    { XMFLOAT3( 1.0f, 0.0f, -1.0f), XMFLOAT3(0.8944272f,  0.4472136f,  0.0f), XMFLOAT2(1.0f, 1.0f) },
    { XMFLOAT3( 0.0f, 2.0f,  0.0f), XMFLOAT3(0.8944272f,  0.4472136f,  0.0f), XMFLOAT2(0.5f, 0.0f) },
    { XMFLOAT3( 1.0f, 0.0f,  1.0f), XMFLOAT3(0.8944272f,  0.4472136f,  0.0f), XMFLOAT2(0.0f, 1.0f) },
